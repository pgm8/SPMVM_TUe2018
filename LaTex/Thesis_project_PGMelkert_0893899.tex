...
\noindent
To recall, there are two different classes of risk models evaluated: first, a fully parametric benchmark is applied to the returns data, the dynamic conditional correlation (DCC) model of \citep{ref:Engle2002}, which is limited in the sense that it only considers Gaussian marginals. The second class consists of the proposed semiparametric model where conditional correlations are estimated using nonparametric k-nearest neighbor (KNN) and random forest (RF) regressors.   \\
...
\fi
Preliminary general conclusion: \\
\noindent
In tranquil market conditions, Kendall consistently results in more exceedances but within acceptance regions than its pearson counterpart. Also: GJR consistently results in more exceedances than garch counterparts. This may result in underestimation of risk in a more volatile period. \\

\noindent
Plots: very little difference between garch and gjr (gjr forecasts tend to be a little bit smoother). Significant difference between pearson and kendall wrt to smoothness var forecasts. Kendall results in less volatilie VaR forecasts (explained by less volatile correlation forecasts due to insensitivity to outliers). \\


\begin{itemize}
	\item Kendall consistently results in more exceedances but within acceptance regions than its 	pearson counterpart.
	\item GJR consistently results in more exceedances than garch counterparts. 
\end{itemize}

\noindent
Table \ref{tab:kupiec_test_norm_tranquil_table} presents an overview of the VaR backtest results under tranquil market conditions for a long position in an equally weighted portfolio comprising the 30 constituents of the DJIA. The backtest results indicate that 

The backtest results indicate that all models except the KNN(5)-Kendall-GJR model are adequate in estimating the 99\% VaR; the models are not rejected by Kupiec and Christoffersen tests at the 5\% level of significance. For the 99\% VaR, the       
...
KNN(idw)-Kendall-GJR          	&\textbf{13}	&11	&2                     &0.0245             &0.0769              &0.0203               &0.0909              &0.0121            &0              \\  \midrule 
...
\begin{figure}[H]  % [h] parameter makes sure figures are located at 'this' location.
	\centering
	\begin{subfigure}[b]{0.49 \textwidth} %7
		\centering 		
		\includegraphics[width=\textwidth, height=0.5\textwidth]{multivar_analysis/tranquil/DCC_garch_mvnorm_1994_1995.pdf} 
		\caption{DCC-Garch} 
		\label{}
	\end{subfigure}
	\hfill  
	\begin{subfigure}[b]{0.49 \textwidth} %8
		\centering 
		\includegraphics[width=\textwidth, height=0.5\textwidth]{multivar_analysis/tranquil/DCC_gjr_mvnorm_1994_1995.pdf} 
		\caption{DCC-GJR} 
		\label{}
	\end{subfigure}
	\begin{subfigure}[b]{0.49 \textwidth} %1
		\centering 
		\includegraphics[width=\textwidth, height=0.5\textwidth]{multivar_analysis/tranquil/KNN5_pearson_garch_1994_1995.pdf} 
		\caption{KNN(5)-Pearson-Garch} 	
		\label{}
	\end{subfigure} 
	\hfill	
	\begin{subfigure}[b]{0.49 \textwidth}  %2
		\centering 
		\includegraphics[width=\textwidth, height=0.5\textwidth]{multivar_analysis/tranquil/KNN5_kendall_garch_1994_1995.pdf} 
		\caption{KNN(5)-Kendall-Garch} 
		\label{}
	\end{subfigure} 
	\hfill	
	\begin{subfigure}[b]{0.49 \textwidth} %3
		\centering 		
		\includegraphics[width=\textwidth, height=0.5\textwidth]{multivar_analysis/tranquil/KNN100_pearson_garch_1994_1995.pdf} 
		\caption{KNN(100)-Pearson-Garch} 
		\label{}
	\end{subfigure}
	\hfill  
	\begin{subfigure}[b]{0.49 \textwidth} %4
		\centering 
		\includegraphics[width=\textwidth, height=0.5\textwidth]{multivar_analysis/tranquil/KNN100_kendall_garch_1994_1995.pdf} 
		\caption{KNN(100)-Kendall-Garch} 
		\label{}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.49 \textwidth} %5
		\centering 		
		\includegraphics[width=\textwidth, height=0.5\textwidth]{multivar_analysis/tranquil/KNN_idw_pearson_garch_1994_1995.pdf} 
		\caption{KNN(idw)-Pearson-Garch} 
		\label{}
	\end{subfigure}
	\hfill  
	\begin{subfigure}[b]{0.49 \textwidth} %6
		\centering 
		\includegraphics[width=\textwidth, height=0.5\textwidth]{multivar_analysis/tranquil/KNN_idw_kendall_garch_1994_1995.pdf} 
		\caption{KNN(idw)-Kendall-Garch} 
		\label{}
	\end{subfigure}
	\hfill	
	\caption[Out-of-sample returns and Value-at-Risk estimates.]{Out-of-sample returns r$_t$ and Value-at-Risk estimates VaR$_{t,\alpha}$ for $\alpha \in \{0.95, 0.975, 0.99\}$ under tranquil market conditions.}
...
RF(100)-Kendall-GJR             	&\textbf{53}	&\textbf{32}	&\textbf{18}         &0.1007        &0.1346              &0.0578               &0.125             &0.0312          &0.1111             \\            
RF(100)-Kendall-Garch           	&\textbf{53}	&\textbf{32}	&\textbf{18}    	&0.1007	&0.1346	&0.0578	&0.1250	&0.0312	&0.1111              \\ [1ex]  

\bottomrule  
\end{tabular}
\caption[Backtesting results under volatile market conditions.]{This table presents the results of unconditional coverage (Kupiec test) and independence (Christoffersen markov test) at higher quantiles of the loss distribution under volatile market conditions. Bold face indicates rejection. Non-rejection regions for the Kupiec test: 15$<$I(0.95)$<$36, 6$<$I(0.975)$<$21 and 0$<$I(0.99)$<$10.}
\label{tab:kupiec_test_norm_tranquil_table}
\end{table}
\end{landscape}
