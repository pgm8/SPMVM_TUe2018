...
\begin{figure} % [h] parameter makes sure figures are located at 'this' location.
	...
	\begin{subfigure}[b]{0.33 \textwidth} %3
		\centering 		
		\includegraphics[width=1.4\textwidth, height=0.7\textwidth]{multivar_analysis/tranquil/KNN100_pearson_garch_1994_1995.pdf} 
		\caption{KNN(100)-Pearson-Garch} 
		\label{fig:KNN(100)-Pearson-Garch}
	\end{subfigure}
	\hfill 
...
\begin{itemize}
	\item The gjr with skewed student t error assumption does not improve over VaR estimation. It seems that VaR derived from the Gaussian models seems adequate enough for the given portfolio and market period to capture fat-taileness.
...
\begin{figure} % [h] parameter makes sure figures are located at 'this' location.
	...
	\begin{subfigure}[b]{0.33 \textwidth} %4
		\centering 
		\includegraphics[width=1.4\textwidth, height=0.7\textwidth]{multivar_analysis/volatile/KNN100_kendall_garch_2000_2001.pdf} 
		\caption{KNN(100)-Kendall-Garch} 
		\label{fig:KNN(100)-Kendall-Garch_vol}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.33 \textwidth} %6
		\centering 
