...
The random forest algorithm is described in pseudocode by \hyperref[alg:RF]{Algorithm\ 2} (inspired from \cite{ref:Hastie2009}).
...
\noindent
One step ahead out-of-sample forecasts are made for the entire out-of-sample test period with re-estimation of conditional volatility and conditional correlation model parameters at each time period (each day). The result is a set of Value-at-Risk forecasts that corresponds in size to the length of out-of-sample test period.    
