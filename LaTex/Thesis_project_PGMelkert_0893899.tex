...
\begin{enumerate}
	...
	\item $D_t$ is obtained by estimation of conditional variances with GARCH(1,1) model with Gaussian and skewed Student t-distributional assumptions for marginal error distributions. 
